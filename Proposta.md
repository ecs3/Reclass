...
>	
1. Tela de boas vindas do aplicativo.
2. Tela de menu com as disciplinas já registradas, com a opção de remover ou adicionar novas matérias. Assim como acesso as configurações para se escolher qualidade e formato do áudio a ser salvo.
3. Ao clicar numa disciplina existente, ira para a lista de aulas gravas com a opção de voltar ao menu
de disciplinas, remover aulas ou gravar novas aulas.
4. Ao optar por uma nova gravação, teremos uma tela de gravação com opções de pausar, resumir e
	parar a gravação e a opção de abrir a câmera para capturar imagens.
5. Ao se apertar stop será pedido o assunto visto naquela aula, esse nome se somará a data e ao
...
6. Em seguida o novo item e mostrado na lista de registros daquela disciplina.
